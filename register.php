  ...
  <body>
    ...
    <div class="form-div">
      ...
      <form action="register.php" method="post">
        ...
        <div class="form-group email">
          <label for="exampleInputEmail1">Email address</label>
          <input type="email" class="form-control formInputs" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" placeholder="Example@student.thomasmore.be" value="<?php if(isset($_POST['email'])){echo $user->getEmail();} ?>"> </div>
        <!--------------Name------------>
        <div class="row" id="name">
          <div class="col">
            <label for="fullName">First name</label>
            <input type="text" class="form-control formInputs" name="firstname" placeholder="first name" value="<?php if(isset($_POST['firstname'])){echo $user->getFirstname();}?>"> </div>
          <div class="col">
            <label for="fullName">Last name</label>
            <input id="lasnemText" type="text" class="form-control formInputs" placeholder="Last name" name="lastname" value="<?php if(isset($_POST['lastname'])){echo $user->getLastname();}?>"> </div>
        </div>
        <!-------------Gender----------!-->
        <div class="form-row gender">
          <div class="col male "> Male </div>
        ...
        <div class="form-group email ">
          <label for="fullName">Birthday</label>
          <input type="text" class="form-control formInputs" placeholder="dd/mm/yy" name="birthday" value="<?php if(isset($_POST['birthday'])){echo $user->getBirthday();}?>"> </div>
        <!-------------Password----------!-->
        <div class="form-group password ">
          <label for="exampleInputPassword1">Password</label>
          <input type="password" class="form-control formInputs" id="exampleInputPassword1" name="password" placeholder="password"> </div>
