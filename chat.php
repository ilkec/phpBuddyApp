...
<body id="feature8">
    ...
    <div id="chatpartner" class="row"><a href="messages.php" class="col backBtn"><i class="fas fa-chevron-left"></i></a>
        <h1 class="col reciverName"><?php echo "you are talking to " . htmlspecialchars($receiverInfo['firstname']); ?>
        </h1>
    </div>
    <div class="chatbox-wrapper">
        ...
        <div class="chatbox">
            ...
            <div class="messageContainer row">
                ...
                <div class="reactionsBox col-lg-2" id="">
                    <a href="" class="reaction-box-icon" id="showReactionBtn"
                        data-messageid="<?php echo $chatMessage['id']?>">
                ...
                <div class="emojisBox" id="">
                    <div role='listbox' aria-orientation='horizontal' class='_1z8q _fy2'>
                        ...
                        <span class='iconn'><img id='<?php echo $emojis['id']?>' alt='<?php echo $emojis['name']?>'
                                class='_1ift _5m3a img' src='<?php echo $emojis['src']?>'></span>
                        <?php endforeach;?>
                    </div>
        ...
        <div class="mt-2">
            ...
            <a href="#" class="btn btn-primary mb-3 btnSendMessages" id="btnSendMessage" name="sendMessage"
                data-sendername="<?php echo $getAllUser['firstname'] . ": "; ?>">Send message</a>
        </div>
    </div>
