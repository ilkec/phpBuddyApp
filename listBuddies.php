        ...
        <div class="cards">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="namesMatches">
                        <?php echo  htmlspecialchars($match['firstname1']) . " " . htmlspecialchars($match['lastname1']) . " &amp; " . htmlspecialchars($match['firstname2']) . " " . htmlspecialchars($match['lastname2']); ?>
                    </p>
